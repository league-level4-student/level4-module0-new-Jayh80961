...
public class IntroToEncapsulation {
	...
	public static void main(String[] args) {
		...
		int fuelintank = run.getFuelInTank();
		int mpg = run.getMpg();
...
class Vehicle {
	...
	public void setColorInTank(String colorInTank) {
		this.color = colorInTank;
	}
